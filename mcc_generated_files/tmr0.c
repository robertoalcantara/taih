...
void TMR0_Initialize(void)
{
    ...
    // TMR0ON enabled; T0SE Increment_hi_lo; PSA assigned; T0CS FOSC/4; T08BIT 8-bit; T0PS 1:32; 
    T0CON = 0xD4;
   ...
   /* Time control flags */
    ...
    if (global_timer.aux_10ms >= 10) {
        ...
        if (global_timer.aux_100ms >= 10 ) {
            ...
            global_timer.aux_1seg++;

            if( global_timer.aux_1seg >= 10 ) {
                global_timer.aux_1seg = 0;
